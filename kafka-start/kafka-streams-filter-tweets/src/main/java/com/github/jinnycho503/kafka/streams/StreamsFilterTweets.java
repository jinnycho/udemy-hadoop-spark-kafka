package com.github.jinnycho503.kafka.streams;
...
public class StreamsFilterTweets {
    public static void main(String[] args) {
        ...
        properties.setProperty(StreamsConfig.DEFAULT_KEY_SERDE_CLASS_CONFIG, Serdes.StringSerde.class.getName()); // serialize
