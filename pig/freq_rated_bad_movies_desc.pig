...
badMoviesWithData = JOIN lowStarMovies BY movieID, nameLookup BY movieID;

highlyRatedbadMovies =
	FOREACH badMoviesWithData GENERATE nameLookup::movieTitle AS movieName,
    badMovies::avgRating AS avgRating, badMoves::numRatings AS numRatings;

highlyRatedbadMoviesSort = ORDER highlyRatedbadMovies BY numRatings DESC;
